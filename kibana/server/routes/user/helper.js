...
module.exports.createUser = function (server, req, userId) {
  ...
  //var token = new Buffer(shasum.digest('base64')).toString('base64');
  ...
  return function() {
    return client.get({
      ...
      shasum.update(email+req.payload.password+realm._source.key);
      var token = new Buffer(shasum.digest()).toString('base64');
